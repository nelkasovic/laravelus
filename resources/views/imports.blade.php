...
<div class="content">
    ...
    <form action="{{action('ImportController@start')}}" data-module="{{ @$module }}" enctype="multipart/form-data"
        method="post">
        @else
        <form action="{{action('ImportController@create')}}" data-module="{{ @$module }}" enctype="multipart/form-data"
            method="post">
            @endif
            @csrf
            ...
            <div class="block block-rounded block-fx-pop block-themed">
                ...
                <div class="block-content block-content-full text-right bg-light">
                    <div class="row">
                        ...
                        <div class="col-xl-2">
                            <button type="submit" class="btn btn-primary btn-block" @if(@$module) @else disabled @endif>
        ...
        <div class="block block-rounded block-fx-pop block-themed">
            ...
            <div class="block-header block-header-default bg-primary-darker">
                ...
                <div class="block-options">
                    <div class="btn-group">
                        @can('create imports')
                        <a class="btn btn-light btn-sm" href="javascript:void(0)" onclick="getImports();">
                            <i class="si si-share-alt mr-1"></i> {{ __('common.Imports') }} XHR</span>
                        </a>
                        <a class="btn btn-primary btn-sm" href="{{action('ImportController@create')}}">
                            <i class="si si-plus mr-1"></i> {{ __('common.Import') }} <span
