      ...
      <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
        <center>
          <table cellspacing="0" cellpadding="0" width="600" class="w320">
            <tr>
              <td class="header-lg" style="text-align: left;">
                {{ $event->name }}
              </td>
            </tr>
            <tr>
              <td style="text-align: left; line-height: 1.8; padding: 20px 10px; ">
                {{ $event->description }}. <a href="">Details</a>.
              </td>
            </tr>
            <tr>
              <td class="button" style="text-align:left; padding-left: 10px;">
                <div>
                  <!--[if mso]>
              ...
              <![endif]--><a class="button-mobile" href="http://"
                    style="background-color:#4a89dc;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">My
                    Account</a></div>
              </td>
            </tr>
          </table>
    ...
    <td align="center" valign="top" width="100%"
      ...
      <center>
        <table cellpadding="0" cellspacing="0" width="600" class="w320">
          <tr>
            <td class="content-padding">
              <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td class="header-md" style="text-align: left;">
                    Veranstaltung
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding-bottom: 60px; padding-left: 10px; text-align: left;">
              <p>Datum: {{ \Carbon\Carbon::parse($event->start_date)->format('d.m.Y')}} -
                {{ \Carbon\Carbon::parse($event->end_date)->format('d.m.Y')}}</p>
              <p>Zeit: {{ \Carbon\Carbon::parse($event->start_date)->format('H:i')}} -
                {{ \Carbon\Carbon::parse($event->end_date)->format('H:i')}}</p>
            </td>
          </tr>
        </table>
      </center>
    ...
    <tr>
      <td align="center" valign="top" width="100%" style="background-color: #f7f7f7; height: 100px;">
        <center>
          <table cellspacing="0" cellpadding="0" width="600" class="w320">
            <tr>
              <td style="padding: 25px 10px 25px; text-align: left; ">
