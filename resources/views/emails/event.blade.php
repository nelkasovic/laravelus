...
<head>
  ...
  <title>{{ __('common.NewTender') }}!</title>
          ...
          <table cellspacing="0" cellpadding="0" width="600" class="w320">
            ...
            <tr>
              <td style="text-align: left; line-height: 1.8; padding: 20px 10px; ">
                {{ __('common.NewTenderDescription') }}.
              </td>
            </tr>
            <tr>
              ...
              <![endif]-->
                  <a class="button-mobile" href="https://drehbu.ch/"
          ...
          <tr>
            <td style="padding-bottom: 60px; padding-left: 10px; text-align: left;">
              ...
              <ul>
                ...
                <li>{{ __('common.Date') }} & {{ __('common.Time') }}
          ...
          <table cellspacing="0" cellpadding="0" width="600" class="w320">
            <tr>
              <td style="padding: 25px 10px 25px; text-align: left; ">
                ...
                {{ $client->locations()->pluck('street_number')->first() }} <br />
                {{ $client->locations()->pluck('zip')->first() }} {{ $client->locations()->pluck('city')->first() }}
                <br /><br />
              </td>
            </tr>
          </table>
